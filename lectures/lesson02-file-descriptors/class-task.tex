...
# rm ./file1
\stoptyping
\item Выведите список текущих точек монитирования:
\starttyping
# mount
\stoptyping
Какая файловая система (тип и устройство) примонтирована к корню дерева (/)?
\item Выведите список запущенных процессов:
\starttyping
# ps -A
\stoptyping
В левом столбце указан номер каждого процесса.
\item Выберите один из процессов и по его номеру найдите соответствующую папку
в виртуальной файловой системе proc:
\starttyping
# ls /proc/<id>
\stoptyping
\item Выведите имя команды и статус выбранного процесса:
\starttyping
# cat /proc/<id>/comm
# cat /proc/<id>/status
\stoptyping
В каком состоянии (State) находится процесс?
