...
$ ls -l file1
\stoptyping
\item Повторите команду {\tt touch}. Что изменилось в метаданных?
...
$ echo aaa > students
\stoptyping
\item Убедитесь в том, что каждая последующая команда {\tt echo} очищает
существующий файл перед выводом.
